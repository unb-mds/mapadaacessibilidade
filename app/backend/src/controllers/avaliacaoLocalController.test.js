...
describe("AvaliacaoLocalController", () => {
  ...
  describe("criarAvaliacaoLocal", () => {
    ...
    it("deve retornar erro 400 se usuário já avaliou o local", async () => {
      ...
      mockRepository.avaliacao.findUnique.mockResolvedValue(
        mockAvaliacaoExistente,
      );
  ...
  describe("listarAvaliacoesLocal", () => {
      ...
      const mockAvaliacoes = [
        {
          id: "avaliacao-1",
          nota: 5,
          fk_usuario_id: "user-1",
          fk_local_id: "local-123",
          usuario: { id: "user-1", nome: "Usuário 1" },
        },
        {
          id: "avaliacao-2",
          nota: 4,
          fk_usuario_id: "user-2",
          fk_local_id: "local-123",
          usuario: { id: "user-2", nome: "Usuário 2" },
        },
      ];
    ...
    it("deve retornar média 0 quando não há avaliações", async () => {
      ...
      mockRepository.local.findUnique.mockResolvedValue({
        id: "local-123",
        nome: "Local Teste",
      });
  ...
  describe("atualizarAvaliacaoLocal", () => {
    it("deve atualizar uma avaliação existente", async () => {
      ...
      mockRepository.avaliacao.update.mockResolvedValue(
        mockAvaliacaoAtualizada,
      );
